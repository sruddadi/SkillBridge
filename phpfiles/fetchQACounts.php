...
$sqlUserCount = "SELECT COUNT(*) as userCount FROM qAUpdates";
$sqlCourseCount = "SELECT COUNT(*) as courseCount FROM qAUpdates where year < 2023";
$sqlProgramCount = "SELECT COUNT(*) as programCount FROM qAUpdates where year > 2023";
